...
//===========================================================================================//
    ...
    #define ISRAM_END_ADDR              0xF8002F60
    #define IRAM_SWAITCH_FLAG_START     0xF8003A00
    #define IRAM_SWAITCH_FLAG_END       0xF8003DAF
    ...
    #define __GPIO_PAD_DEFINE__
         ...
         #define UART_TX_RX_POS              UART_TX_IOF3__RX_IOF8
