...
void gpl32_dynamic_mclk_demo(void);
extern INT16U pic_num;
extern INT32U scaler_ptr,BLOCK_ENCODE;
INT32U uTft_dat,uTft_clk,uTft_cs;
...
void gpl32_dynamic_mclk_demo(void)
{
	...
	INT32U decode_state,encode_state,encode_size,i,counter;
	...
	encode_output_ptr = (INT32U) gp_malloc_align((SCALER_DEV_HPIXEL*32), 16);//malloc decode frame buffer     
	counter=1;
  for(i=0;i<50;i++){
    switch(counter){
       ...
       case 0:
    	     system_clock_set(96);
             MHZ_CK=96;
             DBG_PRINT("dynamically_clock=96\r\n");	
       break;
       case 1:
  	         system_clock_set(78);    	   
             MHZ_CK=78;
             DBG_PRINT("dynamically_clock=78\r\n");	
       break;
       case 2:
  	         system_clock_set(63);
             MHZ_CK=63;
             DBG_PRINT("dynamically_clock=63\r\n");	
       break;
       case 3:
  	         system_clock_set(48);
             MHZ_CK=48;
             DBG_PRINT("dynamically_clock=48\r\n");	
       break;
       case 4:
  	         system_clock_set(63);
             MHZ_CK=63;
	...
	//image decode output information
    ...
    //image scaler output information
    ...
    if(MHZ_CK==96)
    	 sprintf((char *)path, (const char *)"c:\\blockrw_96%03d.jpeg", pic_num);
    else if(MHZ_CK==78)
    	 sprintf((char *)path, (const char *)"c:\\blockrw_78%03d.jpeg", pic_num);
    else if(MHZ_CK==63)
    	 sprintf((char *)path, (const char *)"c:\\blockrw_63%03d.jpeg", pic_num); 
    else
    	 sprintf((char *)path, (const char *)"c:\\blockrw_48%03d.jpeg", pic_num);            
