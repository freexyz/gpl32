...
//===========================================================================================//
...
#ifndef __NOR_FLASH_EN__	
    #define SDRAM_START_ADDR            0x00000000 
    #define SDRAM_END_ADDR              0x01FFFFFF 
#else
    #define SDRAM_START_ADDR            0x20000000
    #define SDRAM_END_ADDR              0x21FFFFFF
#endif
    ...
    #define __GPIO_PAD_DEFINE__
         ...
         #define NAND_CTRL_POS               NF_ALE_IOG5__CLE_IOG6__REB_IOG10__WEB_IOG11//NF_ALE_SHARE_CLE_SHARE_REB_SHARE__WEB_SHARE
    ...
    #ifndef __NOR_FLASH_EN__
         #define CMOS_POS                    CMOS_DATA0_7_CLK1_CLK0_HSYNC_VSTNC__IOA8_15_IOC10_IOH0_IOB5_IOB6
    #else
...
//==========================================================================================//
    ...
    // NAND_DATA_IOI_CTRL_IOF: DATA[7:0]=>IOI[7:0] , ALE/CLE/WEB/REB=>IOF[7:6], IOI[9:8]
    // NAND_DATA_IOB_CTRL_IOC: DATA[7:0]=>IOB[15:8], ALE/CLE/WEB/REB=>IOC[9:6]
    // NAND_DATA_IOA_CTRL_IOC: DATA[7:0]=>IOA[15:8], ALE/CLE/WEB/REB=>IOC[9:6]
    // NAND_DATA_IOA_CTRL_IOC: DATA[7:0]=>IOA[15:8], ALE/CLE/WEB/REB=>IOG[11:10], IOG[5:6]
    // NAND_DATA_IOI_CTRL_IOG: DATA[7:0]=>IOI[7:0] , ALE/CLE/WEB/REB=>IOG[11:10], IOG[5:6] 
    // NAND_DATA_AUTO_CTRL_AUTO : Auto pad scan option 
    #define NAND_DATA_IOI_CTRL_IOF           0
    #define NAND_DATA_IOB_CTRL_IOC           1
    #define NAND_DATA_IOA_CTRL_IOC           2
    #define NAND_DATA_IOA_CTRL_IOG           3
    #define NAND_DATA_IOI_CTRL_IOG           4
