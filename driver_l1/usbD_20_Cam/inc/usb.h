...
#define USB_UVC_VSIF_NUM    1 //Video streamming interface
#else
#define USB_UVC_VCIF_NUM    1 //Video control interface
#define USB_UVC_VSIF_NUM    2 //Video streamming interface
#endif
#define USB_ADC_CIF_NUM     2
#define USB_ADC_SIF_NUM     3
